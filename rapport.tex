...
\href{https://hal.uca.fr/hal-03022007/document}{L'équation de Navier-Stokes}

L'équation de stokes peut être assimiler à la deuxième loi de Newton appliquées aux fluides, 
\begin{equation}
\sum\vec{F}=m\vec{a}
\end{equation}
, avec F les forces, m la masse de ce corps et a son accélération.
...
\begin{equation}
\begin{array}{l}
\frac{D \textrm{v}_\textrm{x}}{Dt} = \frac{\partial \textrm{v}_\textrm{x}}{\partial t} + (\vec{v}.\vec{\nabla})\textrm{v}_\textrm{x} = \frac{\partial \textrm{v}_\textrm{x}}{\partial t} + \textrm{v}_\textrm{x} \frac{\partial \textrm{v}_\textrm{x}}{\partial t} + \textrm{v}_\textrm{y} \frac{\partial \textrm{v}_\textrm{x}}{\partial t} + \textrm{v}_\textrm{z} \frac{\partial \textrm{v}_\textrm{x}}{\partial t}  \\
\frac{D \textrm{v}_\textrm{y}}{Dt} = \frac{\partial \textrm{v}_\textrm{y}}{\partial t} + (\vec{v}.\vec{\nabla})\textrm{v}_\textrm{y} = \frac{\partial \textrm{v}_\textrm{y}}{\partial t} + \textrm{v}_\textrm{x} \frac{\partial \textrm{v}_\textrm{y}}{\partial t} + \textrm{v}_\textrm{y} \frac{\partial \textrm{v}_\textrm{y}}{\partial t} + \textrm{v}_\textrm{z} \frac{\partial \textrm{v}_\textrm{y}}{\partial t} \\
\frac{D \textrm{v}_\textrm{z}}{Dt} = \frac{\partial \textrm{v}_\textrm{z}}{\partial t} + (\vec{v}.\vec{\nabla})\textrm{v}_\textrm{z} = \frac{\partial \textrm{v}_\textrm{y}}{\partial t} + \textrm{v}_\textrm{x} \frac{\partial \textrm{v}_\textrm{z}}{\partial t} + \textrm{v}_\textrm{y} \frac{\partial \textrm{v}_\textrm{z}}{\partial t} + \textrm{v}_\textrm{z} \frac{\partial \textrm{v}_\textrm{z}}{\partial t}
\end{array}
\label{eq1}
\end{equation}
avec $\textrm{v}_\textrm{x}$, $\textrm{v}_\textrm{y}$ et $\textrm{v}_\textrm{z}$ ****************************
\\\\
