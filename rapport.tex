...
\end{verbatim}
\newpage
Nous avons recréé l'équation~\eqref{eq3} en calculant les dérivées partielles selon ${x}$ avec la méthode des différences finies. Cela consiste à calculer la différence entre deux valeurs consécutives.
\newline
